...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002045029099"))
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "ᴍᴜsɪᴄ")

OWNER_ID = list(map(int, getenv("OWNER_ID", "6550354041").split()))

HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)

UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Cutey02/dy")
...
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/47745035b55df257ffe47.jpg")

PING_IMG_URL = getenv(
    "PING_IMG_URL",
    "https://graph.org/file/47745035b55df257ffe47.jpg",
)

PLAYLIST_IMG_URL = "https://graph.org/file/47745035b55df257ffe47.jpg"

GLOBAL_IMG_URL = "https://graph.org/file/47745035b55df257ffe47.jpg"

STATS_IMG_URL = "https://graph.org/file/47745035b55df257ffe47.jpg"
